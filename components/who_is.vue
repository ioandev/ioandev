<template>
  <div class=" bg-gray-900 py-20" id="story">
    <div class="px-4 md:px-20">
    <div class="container mx-auto py-20 bg-gray-800 relative who_is_ioan">
      <img class="h-30 w-auto absolute top-0 right-0 -mr-2 -mt-2 rounded-full cool_shadow2"
        src="../assets/img/profile.jpg" alt="Workflow logo">
      <div class="block md:flex mr-20">
        <div class="hidden md:block md:w-1/4">
          <div class="mx-auto flex">
            <p>&nbsp;</p>
          </div>
        </div>
        <div class="md:w-3/4 pl-10 md:pl-0">
