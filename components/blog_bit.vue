<template>
  <div>
    ...
    <p class="px-20">Following are some of the public posts on my blog, the private once are very informative.</p>

    <div class="hidden sm:block lg:hidden md:hidden w-full">
    ...
    <div class="hidden sm:hidden lg:block md:hidden w-full">
    ...
    <div class="hidden sm:hidden lg:hidden md:block w-full py-10">
